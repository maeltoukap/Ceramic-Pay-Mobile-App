...
class Api {
  static scanQrCode() async {
    try {
      final Response = await http.get(Uri.parse(Url.getQrCode));
  ...
  static getCoupons(String idUser) async {
    try {
      final response =
          await http.post(Uri.parse(Url.getCoupons), body: {"idUser": idUser});
  ...
  static listCoupons(String idUser) async {
    try {
      final response =
          await http.post(Uri.parse(Url.listCoupons), body: {"idUser": idUser});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
        return null;
  ...
  static listArchives(String idUser) async {
    try {
      final response =
          await http.post(Uri.parse(Url.listArchives), body: {"idUser": idUser});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
        return null;
  ...
  static listPaid(String idUser) async {
    try {
      final response = await http.post(Uri.parse(Url.listPaid), body: {"idUser": idUser});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
        return null;
  ...
  static listLoad(String idUser) async {
    try {
      final response = await http.post(Uri.parse(Url.listLoad), body: {"idUser": idUser});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
        return null;
  ...
  static countNonValider(String idUser) async {
    try {
      final response =
          await http.post(Uri.parse(Url.countNonValider), body: {"idUser": idUser});
      if (response.statusCode == 200) {
  ...
  static countValider(String idUser) async {
    try {
      final response =
          await http.post(Uri.parse(Url.countValider), body: {"idUser": idUser});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
        return null;
  ...
  static getAmount(String idUser) async {
    try {
      final response = await http.post(Uri.parse(Url.getAmount), body: {"idUser": idUser});
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      } else {
        return null;
