...
class RegisterScreenState extends State<RegisterScreen> {
  ...
  void login(int phone, String password) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // var dfText= await json.decode(json.encode(response.body);
        // var data = jsonDecode(response.body);
        // var result = data['data'];
        // int succes = result[1];
  ...
  String error = "";
  void register(String name, int phone, String password, String ville) async {
    setState(() {
      error = "";
      // _loading = true;
      isLoggin = true;
    ...
    print(b.runtimeType);
    // date = date.toString();
    final response = await http.post(Uri.parse(Url.ApiLink + "/register.php"),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Inscrivez vous pour scanner vos coupons et encaisser vos lots",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 20.0,
                              ...
                              InkWell(
                                onTap: () {
                                  if (_formKey.currentState.validate()) {
                                    register(this._name.text, this._phoneNumber,
                                        this._password.text, this._town.text);
                                  }
                                },
                                child: Container(
